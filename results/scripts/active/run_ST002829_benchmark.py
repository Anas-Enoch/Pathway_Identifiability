...
DATASETS = {
    "ST002829": DATA_DIR / "ST002829_benchmark_ready.csv",
}

# explicit case/control for datasets not matched by choose_case_ctrl() aliases
CASE_CTRL_OVERRIDE = {
    "ST002829": ("severe", "mild"),   # severe = case, mild = control
}

PATHWAY_MAP = DATA_DIR / "ST002829_pathway_mapping.csv"

OUT_FILE = OUT_DIR / "ST002829_benchmark_results.csv"
