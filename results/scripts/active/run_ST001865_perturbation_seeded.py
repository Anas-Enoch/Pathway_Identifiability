...
# ── Deterministic seed: ensures identical results across runs ──────────
GLOBAL_SEED = 42
...
DATASETS = {
    "ST001865": DATA_DIR / "ST001865_standard.csv",
}
...
OUT_FILE = OUT_DIR / "ST001865_perturbation_results.csv"
...
ALPHA_FGW = 0.5
SINK_REG = 0.5
SINK_MAX_ITER = 300  # 5000 was too slow; 300 sufficient
EPS = 1e-12
